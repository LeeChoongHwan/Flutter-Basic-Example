...
class Memo {
  Memo({required this.content, this.pinned = false, this.updateTime});
  ...
  Map toJson() {
    return {'content': content, 'pinned' : pinned,
    'updateTime' : updateTime?.toIso8601String()};
  }

  factory Memo.fromJson(json) {
    return Memo(content: json['content'], pinned: json['pinned'] ?? false,
    updateTime: json['updateTime'] == null ? null : DateTime.parse(json['updatedAt']),);
  }
}
